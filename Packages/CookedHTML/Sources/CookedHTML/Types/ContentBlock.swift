...
public enum ContentBlock: Sendable, Equatable {
    ...
    case discourseQuote(username: String?, avatarURL: String?, content: [ContentBlock])
    case image(src: String, alt: String?, width: Int?, height: Int?)
    case onebox(sourceURL: String?, title: String?, description: String?, imageURL: String?)
